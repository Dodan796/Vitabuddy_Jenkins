	...
	<section id="wrap">
		<div class="container">
			...
			<button class="submit-btn"
				onclick="location.href='/member/myInfoChangeForm?userId=${sessionScope.sid}'">회원
				정보 수정하기</button>
			<div class="review-section">
				<h3>내가 작성한 리뷰 목록</h3>
				<form action="/myPage/reviews" method="get">
					<label for="sort">정렬 기준:</label> <select name="sort" id="sort"
